...
public class ServerVerticle extends AbstractVerticle {
    ...
    public void start(Future<Void> future) throws Exception {
        ...
        this.redisHandler = new RedisHandler(RedisClient.create(vertx, redisConfig), config);
    ...
    private Router createRouter() {
        ...
        router.route("/*").handler(StaticHandler.create().setCachingEnabled(false).setFilesReadOnly(false));
        return router;
    }
